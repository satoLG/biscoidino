// Menu Section - Product listing
import { Section } from './Section';
import { products, Product } from '../data';

export class MenuSection extends Section {
  render(): string {
    // Store menu items data globally for modal use (like original)
    (window as any).menuItemsData = products;
